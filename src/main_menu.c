 ...
 * Task_NewGameBirchSpeech_StartBirchRayquazaPlatformFade
 * Task_NewGameBirchSpeech_StartBirchRayquazaPlatformFade
 ...
 * Task_NewGameBirchSpeech_ReshowBirchRayquaza
 ...
 *  - Advances to Task_NewGameBirchSpeechSub_WaitForRayquaza
 * Task_NewGameBirchSpeechSub_WaitForRayquaza
...
static void Task_NewGameBirchSpeechSub_WaitForRayquaza(u8);
static void Task_NewGameBirchSpeech_StartBirchRayquazaPlatformFade(u8);
...
static void Task_NewGameBirchSpeech_ReshowBirchRayquaza(u8);
...
#define tRayquazaSpriteId data[9]
...
{
    u8 spriteId = gTasks[sBirchSpeechMainTaskId].tRayquazaSpriteId;
    ...
    gTasks[taskId].func = Task_NewGameBirchSpeechSub_WaitForRayquaza;
    gTasks[sBirchSpeechMainTaskId].tTimer = 0;
}

static void Task_NewGameBirchSpeechSub_WaitForRayquaza(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    struct Sprite *sprite = &gSprites[gTasks[sBirchSpeechMainTaskId].tRayquazaSpriteId];
...
static void Task_NewGameBirchSpeech_AndYouAre(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        ...
        AddTextPrinterForMessage(TRUE);
        gTasks[taskId].func = Task_NewGameBirchSpeech_StartBirchRayquazaPlatformFade;
    }
}

static void Task_NewGameBirchSpeech_StartBirchRayquazaPlatformFade(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
        gSprites[gTasks[taskId].tRayquazaSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static void Task_NewGameBirchSpeech_StartPlayerFadeIn(u8 taskId)
{
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        gSprites[gTasks[taskId].tRayquazaSpriteId].invisible = TRUE;
        if (gTasks[taskId].tTimer)
        {
            gTasks[taskId].tTimer--;
        }
...
static void Task_NewGameBirchSpeech_StartNamingScreen(u8 taskId)
{
    ...
    {
        FreeAllWindowBuffers();
        FreeAndDestroyMonPicSprite(gTasks[taskId].tRayquazaSpriteId);
...
static void Task_NewGameBirchSpeech_SlidePlatformAway2(u8 taskId)
{
    ...
    {
        gTasks[taskId].func = Task_NewGameBirchSpeech_ReshowBirchRayquaza;
    }
}

static void Task_NewGameBirchSpeech_ReshowBirchRayquaza(u8 taskId)
{
    u8 spriteId;
    ...
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        gSprites[spriteId].invisible = FALSE;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_BLEND;
        spriteId = gTasks[taskId].tRayquazaSpriteId;
        gSprites[spriteId].x = 100;
        gSprites[spriteId].y = 75;
        gSprites[spriteId].invisible = FALSE;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static void Task_NewGameBirchSpeech_WaitForSpriteFadeInAndTextPrinter(u8 taskId)
{
    ...
    {
        gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        gSprites[gTasks[taskId].tRayquazaSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        if (!RunTextPrintersAndIsPrinter0Active())
        {
            gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
            gSprites[gTasks[taskId].tRayquazaSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static u8 NewGameBirchSpeech_CreateRayquazaSprite(u8 x, u8 y)
{
...
static void AddBirchSpeechObjects(u8 taskId)
{
    ...
    rayquazaSpriteId = NewGameBirchSpeech_CreateRayquazaSprite(100, 0x4B);
    gSprites[rayquazaSpriteId].callback = SpriteCB_Null;
    gSprites[rayquazaSpriteId].oam.priority = 0;
    gSprites[rayquazaSpriteId].invisible = TRUE;
    gTasks[taskId].tRayquazaSpriteId = rayquazaSpriteId;
